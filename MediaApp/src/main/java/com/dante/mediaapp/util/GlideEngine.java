package com.dante.mediaapp.util;
...
public class GlideEngine implements ImageEngine {
     ...
     */
    @Override
    public void loadImage(@NonNull Context context, @NonNull String url, @NonNull final ImageView imageView, final SubsamplingScaleImageView longImageView, final ImageCompleteCallback callback) {
        Glide.with(context)
                .asBitmap()
                .load(url)
