...
public class Practice13GetTextBoundsView extends View {
    ...
    private float yOffset4;
    private float yOffset5;
    private float yOffset6;

    {
        ...
        yOffset1 = (rect.bottom + rect.top) / 2;

        paint2.getTextBounds(text2, 0, text2.length(), rect);
        yOffset2 = (rect.bottom + rect.top) / 2;

        paint2.getTextBounds(text3, 0, text3.length(), rect);
        yOffset3 = (rect.bottom + rect.top) / 2;

        paint2.getTextBounds(text4, 0, text4.length(), rect);
        yOffset4 = (rect.bottom + rect.top) / 2;

        paint2.getTextBounds(text5, 0, text5.length(), rect);
        yOffset5 = (rect.bottom + rect.top) / 2;

        paint2.getTextBounds(text6, 0, text6.length(), rect);
        yOffset6 = (rect.bottom + rect.top) / 2;

        Log.e("P-3-13", "-----------:" + yOffset1);
        Log.e("P-3-13", "-----------:" + yOffset2);
        Log.e("P-3-13", "-----------:" + yOffset3);
        Log.e("P-3-13", "-----------:" + yOffset4);
        Log.e("P-3-13", "-----------:" + yOffset5);
        Log.e("P-3-13", "-----------:" + yOffset6);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(text1, 100, middle - yOffset1, paint2);
        canvas.drawText(text2, 200, middle - yOffset2, paint2);
        canvas.drawText(text3, 300, middle - yOffset3, paint2);
        canvas.drawText(text4, 400, middle - yOffset4, paint2);
        canvas.drawText(text5, 500, middle - yOffset5, paint2);
        canvas.drawText(text6, 600, middle - yOffset6, paint2);
    }
}