package com.siberiadante.customview.hencoder.practice5.sample;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (DEBUG) {
            ...
            if (drawable != null) {
                ...
                canvas.drawText(getResources().getString(R.string.image_size, bounds.width(), bounds.height()), 60, 60, paint);
                canvas.restore();
            }
        }
    }
