package com.siberiadante.customview.hencoder.practice4;
...
public class Page4Fragment extends Fragment {
    ...
    public static Page4Fragment newInstance(@LayoutRes int sampleLayoutRes, @LayoutRes int practiceLayoutRes) {
