...
public class Sample03OfObjectLayout extends RelativeLayout {
    ...
    private class PointFEvaluator implements TypeEvaluator<PointF> {
        ...
        public PointF evaluate(float fraction, PointF startValue, PointF endValue) {
            ...
            Log.i("7-Sample03","--endValue.x="+endValue.x+"--startValue.x="+startValue.x+"--endValue.y="+endValue.y+"--startValue.y="+startValue.y);
            Log.i("7-Sample03","--x="+x+"--y="+y+"--fraction="+fraction);
