package com.siberiadante.customview.hencoder.practice7.sample.sample03;
...
public class Sample03OfObjectView extends View {
    public static final float RADIUS = TransitionUtil.dpToPixel(20);
    ...
    public void onDraw(Canvas canvas) {
        ...
        float rw = innerPaddingLeft + RADIUS + width * position.x;
        float ry = innterPaddingTop + RADIUS + height * position.y;
        Log.e("Sam3", "----------width:" + width + "----------------height:" + height);
        Log.e("Sam3", "----------:" + rw + "----------------:" + ry);
        canvas.drawCircle(innerPaddingLeft + RADIUS + width * position.x, innterPaddingTop + RADIUS + height * position.y, RADIUS, paint);
//        canvas.drawCircle(60* position.x, 60* position.y , RADIUS, paint);
    }
}
