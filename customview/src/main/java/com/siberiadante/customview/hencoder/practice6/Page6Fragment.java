package com.siberiadante.customview.hencoder.practice6;
...
public class Page6Fragment extends Fragment {
    ...
    public static Page6Fragment newInstance(@LayoutRes int sampleLayoutRes, @LayoutRes int practiceLayoutRes) {
